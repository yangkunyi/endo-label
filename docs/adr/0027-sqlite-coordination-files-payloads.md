...
- ADR 0026's id-keyed labels stand: a vocab rename touches only the registry row — the multi-file rewrite transactions in `labels_store.py` disappear.

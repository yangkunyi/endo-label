Status: specified — tickets 01–02 resolved; tickets 03–06 ready-for-agent
...
- [03 — Several identities in one Apply; Ruler and ghost preview](issues/03-multi-brush-and-range-preview.md) (`ready-for-agent`)

Status: specified — ticket 01 resolved; tickets 02–06 ready-for-agent
...
- [02 — Brush replaces the paint chip; Library name stays this-Frame](issues/02-brush-replaces-paint-chip.md) (`ready-for-agent`)
- [03 — Several identities in one Apply; Ruler and ghost preview](issues/03-multi-brush-and-range-preview.md) (`ready-for-agent`, blocked by 02)
- [04 — Lane bars seek under the pointer, paint on empty drag, Shift-select, trim, Backspace](issues/04-lane-seek-paint-select-trim.md) (`ready-for-agent`, blocked by 01)
- [05 — Library eye shows or hides a Lane; unused start hidden](issues/05-lane-visibility-eye.md) (`ready-for-agent`, blocked by 01, 04)
